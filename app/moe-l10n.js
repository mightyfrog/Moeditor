...
const strings = {
    ...
    "ja": {
        ...
        "Save": "保存",
        "Save as": "名前を付けて保存",
        "Export as HTML": "HTMLにエクスポート",
        "Export as PDF": "PDFにエクスポート",
        "Settings": "設定",
        "About": "About",

        "Menu": "メニュー",
        "Directory": "ディレクトリ",
        "Toggle focus mode": "フォーカスモード切り替え",
        "Edit mode": "編集モード",
        ...
        "Save changes to file?": "変更をファイルに保存しますか？",
        "File changed by another program, reload?": "別のプログラムにファイルが変更されています。読み込み直しますか？",

        "Markdown Documents": "Markdown 文書",
        "HTML Documents": "HTML 文書",
        "PDF Documents": "PDF 文書",
        "CSS Files": "CSS ファイル",
        "All Files": "すべてのファイル",
        "Saved successfully.": "保存しました",
        "Can't save file": "ファイルを保存できません",
        "Exporting as HTML, please wait ...": "HTMLにエクスポートしています…",
        "Exporting as PDF, please wait ...": "PDFにエクスポートしています…",
        "Can't export as HTML": "HTMLにエクスポートできません",
        "Can't export as PDF": "PDFにエクスポートできません",
        ...
        "Render": "描画",
        "Language": "言語",
        "Reload when file changed": "ファイル変更時の再読み込み",
        "Font": "エディタフォント",
        "Font Size": "フォントサイズ",
        "Line Height": "行の高さ",
        "Tab Size": "タブサイズ",
        "Color Theme": "カラーテーマ",
        "TeX Math Expressions":"TeX 数式",
        "UML Diagrams": "UML ダイアグラム",
        "Brakes": "Brakes",
        "Highlight Theme": "ハイライトテーマ",
        "Render Theme": "描画テーマ",
        "Custom CSSs": "カスタム CSSs",
